...
- **M5** `src/ui.c` (dialogue box), `src/fade.c` (fades), camera in `src/game.c`:
  ...
  VRAM (words): BG1 map `0x0000`, BG1 tiles `0x2000`, **BG3 map `0x1000`**, **BG3 font
  `0x3000`** (96 glyphs re-packed 2bpp from `tools/font8.pic`). BG3 palette -> CGRAM 16..19
...
tools/gen-dummy-gfx.js   regenerates src/assets.* ; tools/font8.pic is the vendored 8x8 font

...
app.on("ready", async () => {
  ...
  if (isDevMode) {
    ...
    try {
      ...
      // Devtools extension download/unzip can fail offline or when no
      // unzip tool is on PATH; don't let that block the app from starting.
      console.warn("Skipping devtools extension install:", e);
    }
  }
